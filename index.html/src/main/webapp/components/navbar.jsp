...
<nav class="navbar navbar-expand-lg navbar-dark custom-bg ">
  ...
  <button class="navbar-toggler select" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link" href="login.jsp">Login</a>
         ...
         <li class="nav-item active">
        <a class="nav-link" href="register.jsp">Regester</a>
      </li>
