        ...
        <div class="row mt-3 mx-2">
            ...
            <div class="col-md-2 back">
                ...
                for(Category c:clist){
                   ...
                   <a href="index.jsp?category=<%= c.getCategoryId()%>" class="list-group-item list-group-item-action category"><%= c.getCategoryTitle()%></a>  
                ...
                %>
                  ...
                  <!--show products--> 
            <div class="col-md-10 back text-center">
